...
public class Tank1 extends TankBasic {
	...
	public Tank1(Sol sol, Equipe equipe, int abscisse, int vie, ComposableElementsGraphiques composable) throws IOException {
		super(sol, equipe, abscisse, vie, ImageIO.read(new File("src/Images/tank1.png")),
				...
				38,
				new Position(61, 45), new Position(0, 37),
				composable);
	}
